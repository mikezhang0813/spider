...
#t=5e5062e82f15fe4ca9d24bc5
#e=function(t)
#i=0
#n=0
#a=012345677890123
#s=1
api_url = "https://vipapi.qimingpian.com/search/productNewList"
data = {
    "page": 1,
    "num": 20,
    "unionid": ""
}
encrp_data = requests.post(api_url,data=data).json()['encrypt_data']
# print(encrp_data)
js_text = """
        ...
        function o(t) {
            return JSON.parse(s("5e5062e82f15fe4ca9d24bc5", i(t), 0, 0, "012345677890123", 1))
        }
"""
ctx = execjs.compile(js_text)
info = ctx.call("o","OEHeZX/WiEOCFPCIyfg14/PPo6DXoSXMp92Cs67YWbGFoFdc2Ck2Zwt5fTEbWr+jkWR3MWOEiaXREV/aS2rhCA==")
print(info)